  ...
  return (
    <footer className="border-t border-yellow-400/20 bg-black">
      <div className="px-5 md:px-10 max-w-7xl mx-auto py-12 grid md:grid-cols-3 gap-8">
        <div>
          <div className="font-display text-white text-2xl">MINEX BLOCK</div>
          <p className="font-mono text-xs text-stone-500 mt-3 max-w-xs leading-relaxed">
            A multiplayer voxel mining game. Dig the Minexdron, claim the prize pool.
          </p>
        </div>
        <div>
          <div className="font-mono text-[10px] tracking-[0.2em] text-stone-500 mb-3">// NAVIGATE</div>
          <div className="grid grid-cols-2 gap-2 font-mono text-xs">
            {['MISSION', '$MINEX', 'ARTEFACTS', 'EQUIPMENT', 'MARKETPLACE'].map((x) => (
        ...
        <div>
          ...
          <p className="font-mono text-[10px] tracking-[0.2em] text-stone-600 mt-6">© MINEX BLOCK 2025</p>
        </div>
      </div>
    </footer>
  );
